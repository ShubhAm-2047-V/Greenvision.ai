      ...
      <section style={{ minHeight: '88vh', display: 'flex', alignItems: 'center', padding: '20px 16px', gap: '32px', flexWrap: 'wrap' }}>
        <div style={{ flex: '1 1 280px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginTop: '8px' }}>
            ...
            <Link href="/presentation" className="sk-button" style={{ textDecoration: 'none', padding: '16px 32px', fontSize: '16px', border: '1px solid var(--primary)', color: 'var(--primary)' }}>
              🎯 View Presentation
            </Link>
          </div>
        </div>
