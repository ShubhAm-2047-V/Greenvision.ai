...
const Icon = ({ name, className = "", style = {} }) => {
  const defaultStyle = { width: '24px', height: '24px', ...style };
  
  const icons = {
    'sprout': (
      <svg fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className} style={defaultStyle}>
